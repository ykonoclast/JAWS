...
public class HorribleServlet extends HttpServlet
{
	...
	{
	    //mange silencieusement toute exception comme un gros dégueulasse
	}
	...
	if (req.getParameterMap().containsKey("id"))
	{
		...
		{
		    //dévore les exceptions comme des loukoums en suçotant avec contentement
		}
	    }
	    else
	    {
		if (str2 != null) // turn
		{
		    ...
		    {
			case "NE":
			    orient = MapObject.Orientation.NE;
			    break;
			case "E":
			    orient = MapObject.Orientation.E;
			    break;
			case "SE":
			    orient = MapObject.Orientation.SE;
			    break;
			case "SW":
			    orient = MapObject.Orientation.SW;
			    break;
			case "W":
			    orient = MapObject.Orientation.W;
			    break;
			case "NW":
			    orient = MapObject.Orientation.NW;
			    break;
		    }
		    try
		    {
		    ...
		    {
			//traitement d'erreur? Quel traitement d'erreur?
		    }
		}
		else
		{
	...
	//tour courant
	String tour = "<h2>Tour " + m_report.currentTurn + "</h2>";
	...
	response.getWriter().println("<body>" + tour + impulsion + joueur + listTotale + list2Move + form + "</body>");
    }
}
